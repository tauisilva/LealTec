...
<div class="modal fade" id="modalDesktop" tabindex="-1" role="dialog" aria-labelledby="modalDesktopLabel"
  ...
  <div class="modal-dialog form-dark" role="document">
    <!--Content-->
    <div class="modal-content card card-image" style="background-image: url('img/migamer.jpeg'); border-radius: 20px;">
        ...
        <div class="modal-body">
          ...
          <div class="row d-flex align-items-center mb-4">
            <div class="text-center mb-3 col-md-12" >
              <button type="button" class="btn btn-outline-success btn-rounded waves-effect btn-block z-depth-1" data-toggle="modal" data-target="#modalComputador" style="border-radius: 20px;">Computador</button>
            </div>
            <div class="text-center mb-3 col-md-12" >
              <button type="button" class="btn btn-outline-success btn-rounded waves-effect btn-block z-depth-1"  data-toggle="modal" data-target="#modalNotebooks"style="border-radius: 20px;">Notebook</button>
            </div>
          </div>
        </div>
